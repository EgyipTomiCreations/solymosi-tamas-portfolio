  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="h-10 w-10 rounded-full  bg-[rgba(40,40,40,0.80)] flex items-center justify-center"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end  rounded-2xl bg-[rgba(40,40,40,0.80)] px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
